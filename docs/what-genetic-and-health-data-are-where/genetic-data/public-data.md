...
Downloadable using gcloud CLI here (this is not a clickable website link): `gs://genesandhealth_publicdatasets/`  

Or via Google Cloud Console (likely slower): [`https://console.cloud.google.com/storage/browser/genesandhealth_publicdatasets`](https://console.cloud.google.com/storage/browser/genesandhealth_publicdatasets){target="_blank"}  
